...
GO
PRINT N'Creating Procedure [dbo].[rptOnlinePaymentByFromDateToDate]...';
...
AS
 ...
 ,FORMAT (pl.createdOn, 'dd/MM/yyyy, hh:mm') as PaymentDate
	...
	,isnull(sum(amount),0) as TotalAmount
	   ...
	   where FORMAT (pl.createdOn, 'dd/MM/yyyy')>=FORMAT (@pFromDate, 'dd/MM/yyyy') 
	   -- pl.createdOn>='2021-03-02'
