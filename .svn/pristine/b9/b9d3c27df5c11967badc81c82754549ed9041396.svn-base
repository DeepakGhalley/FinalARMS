...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_mstSlab] ([slabId], [taxId], [slabName], [landUseSubCategoryId], [define1], [define2], [slabStart], [slabEnd], [buildingUnitUseTypeId], [buildingUnitClassId], [isActive], [createdOn], [createdBy], [modifiedOn], [modifiedBy])
        SELECT   [slabId],
                 [taxId],
                 [slabName],
