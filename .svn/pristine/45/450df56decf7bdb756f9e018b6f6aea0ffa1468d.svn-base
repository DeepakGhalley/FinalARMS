...
GO
PRINT N'Dropping Default Constraint [dbo].[DF__tblHouseA__isTer__27C3E46E]...';


GO
ALTER TABLE [dbo].[tblHouseAllocation] DROP CONSTRAINT [DF__tblHouseA__isTer__27C3E46E];
...
GO
PRINT N'Dropping Default Constraint [dbo].[DF__tblStallA__isTer__2B947552]...';


GO
ALTER TABLE [dbo].[tblStallAllocation] DROP CONSTRAINT [DF__tblStallA__isTer__2B947552];
...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_tblHouseAllocation_ToTable_2]...';


GO
ALTER TABLE [dbo].[tblHouseAllocation] DROP CONSTRAINT [FK_tblHouseAllocation_ToTable_2];
...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_tblHouseAllocation_ToTable]...';


GO
ALTER TABLE [dbo].[tblHouseAllocation] DROP CONSTRAINT [FK_tblHouseAllocation_ToTable];
...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_tblStallAllocation_ToTable]...';
...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_tblStallDetail_ToTable_1]...';
...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_tblStallDetail_ToTable]...';
...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_tblStallPeriod_ToTable]...';
...
GO
PRINT N'Starting rebuilding table [dbo].[tblHouseAllocation]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_tblHouseAllocation] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_tblHouseAllocation1] PRIMARY KEY CLUSTERED ([houseAllocationId] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[tblHouseAllocation])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_tblHouseAllocation] ON;
        INSERT INTO [dbo].[tmp_ms_xx_tblHouseAllocation] ([houseAllocationId], [houseDetailId], [taxPayerId], [billingScheduleId], [allocationDate], [rentalAmount], [hasSecurityDeposit], [securityAmount], [remarks], [isTerminated], [terminateDate], [terminateReason], [terminatedBy], [createdBy], [createdOn], [modifiedBy], [modifiedOn])
        SELECT   [houseAllocationId],
                 [houseDetailId],
                 [taxPayerId],
                 [billingScheduleId],
                 [allocationDate],
                 ...
                 [modifiedOn]
        FROM     [dbo].[tblHouseAllocation]
        ORDER BY [houseAllocationId] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_tblHouseAllocation] OFF;
    END

DROP TABLE [dbo].[tblHouseAllocation];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_tblHouseAllocation]', N'tblHouseAllocation';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_tblHouseAllocation1]', N'PK_tblHouseAllocation', N'OBJECT';
...
GO
PRINT N'Starting rebuilding table [dbo].[tblHouseDetail]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_tblHouseDetail] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[tblHouseDetail])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_tblHouseDetail] ON;
        INSERT INTO [dbo].[tmp_ms_xx_tblHouseDetail] ([houseDetailId], [houseNo], [houseAddress], [remarks], [isActive], [createdBy], [createdOn], [modifiedBy], [modifiedOn])
        SELECT   [houseDetailId],
                 ...
                 [modifiedOn]
        FROM     [dbo].[tblHouseDetail]
        ORDER BY [houseDetailId] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_tblHouseDetail] OFF;
    END

DROP TABLE [dbo].[tblHouseDetail];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_tblHouseDetail]', N'tblHouseDetail';
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_tblStallDetail] ([stallDetailId], [stallLocationId], [stallNo], [stallName], [stallArea], [remarks], [isActive], [createdBy], [createdOn], [modifiedBy], [modifiedOn], [stallTypeId])
...
GO
PRINT N'Starting rebuilding table [dbo].[tblStallPeriod]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_tblStallPeriod] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[tblStallPeriod])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_tblStallPeriod] ON;
        INSERT INTO [dbo].[tmp_ms_xx_tblStallPeriod] ([stallPeriodId], [stallAllocationId], [startDate], [EndDate], [remarks], [createdBy], [createdOn], [modifiedBy], [modifiedOn])
        SELECT   [stallPeriodId],
                 [stallAllocationId],
                 [startDate],
                 [EndDate],
                 [remarks],
                 ...
                 [modifiedOn]
        FROM     [dbo].[tblStallPeriod]
        ORDER BY [stallPeriodId] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_tblStallPeriod] OFF;
    END

DROP TABLE [dbo].[tblStallPeriod];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_tblStallPeriod]', N'tblStallPeriod';
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[tblStallAllocation]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_tblHouseAllocation_ToTable_2]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_tblHouseAllocation_ToTable]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_tblStallAllocation_ToTable]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_tblStallDetail_ToTable]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_tblStallPeriod_ToTable]...';
