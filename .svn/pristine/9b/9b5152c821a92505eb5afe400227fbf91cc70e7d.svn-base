...
namespace CORE_BOL
{
    public partial class FullPropertyTransferModel
    {
        public int TrnFtlandDetailId { get; set; }
    ...
    public class LocalLandJointOwners
    {
        public long LandOwnershipId { get; set; }
