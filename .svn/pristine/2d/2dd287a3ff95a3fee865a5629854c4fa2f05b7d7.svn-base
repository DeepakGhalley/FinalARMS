...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_mstSlab_ToTable_5]...';


GO
ALTER TABLE [dbo].[mstSlab] DROP CONSTRAINT [FK_mstSlab_ToTable_5];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_mstSlab] ([slabId], [taxId], [slabName], [landUseSubCategoryId], [define1], [define2], [slabStart], [slabEnd], [constructionTypeId], [buildingUnitUseTypeId], [buildingUnitClassId], [waterLineTypeId], [effectiveDate], [isActive], [createdOn], [createdBy], [modifiedOn], [modifiedBy])
        SELECT   [slabId],
                 [taxId],
                 [slabName],
