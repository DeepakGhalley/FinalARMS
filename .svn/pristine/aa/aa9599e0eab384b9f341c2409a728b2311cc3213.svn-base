...
namespace Safe
{
    public class SafeUtil
    {
        /// <summary>
        /// </summary>
        /// <param name="OriginalString">：UTF8</param>
        /// <param name="SignatureString">：base64</param>
        ...
        /// <param name="privateKeyPath">D:/BoLTS.key</param>
        /// <returns></returns>
        /// 
        public string Sign(string data, string privateKeyPath)
        {
            ...
            RSACryptoServiceProvider rsa = LoadCertificateFile(privateKeyPath);
            byte[] dataBytes = Encoding.UTF8.GetBytes(data);
            byte[] signatureBytes = rsa.SignData(dataBytes, "SHA1");

            SignedString = BitConverter.ToString(signatureBytes);
