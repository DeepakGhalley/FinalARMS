...
GO
PRINT N'Rename refactoring operation with key 91a6e2fd-687b-40c9-abf3-467b67ae5e80 is skipped, element [dbo].[mstSlab].[l] (SqlSimpleColumn) will not be renamed to waterLineTypeId';


GO
PRINT N'Rename refactoring operation with key 750ed691-55b6-48ca-84c4-87b726e10247 is skipped, element [dbo].[trnWaterMeterReading].[connectReconnectTransactionId] (SqlSimpleColumn) will not be renamed to createTransactionId';
...
GO
PRINT N'Altering Table [dbo].[tblWaterMeterReading]...';


GO
ALTER TABLE [dbo].[tblWaterMeterReading]
    ADD [createTransactionId] BIGINT NULL;
...
ALTER TABLE [dbo].[trnWaterConnection]
    ADD [oldWaterConnectionId] INT NULL;
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_mstSlab_ToTable_5]...';


GO
ALTER TABLE [dbo].[mstSlab] WITH NOCHECK
    ADD CONSTRAINT [FK_mstSlab_ToTable_5] FOREIGN KEY ([waterLineTypeId]) REFERENCES [dbo].[mstWaterLineType] ([waterLineTypeId]);
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '91a6e2fd-687b-40c9-abf3-467b67ae5e80')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('91a6e2fd-687b-40c9-abf3-467b67ae5e80')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '750ed691-55b6-48ca-84c4-87b726e10247')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('750ed691-55b6-48ca-84c4-87b726e10247')
...
ALTER TABLE [dbo].[mstSlab] WITH CHECK CHECK CONSTRAINT [FK_mstSlab_ToTable_5];
