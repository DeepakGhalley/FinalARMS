...
namespace ARMS.Areas.BuildingUnit.Controllers
{
    ...
    public class BuildingUnitUseTypesController : Controller
    {
        ...
        [Route("BuildingUnit/BuildingUnitUseTypes")]
        ...
        [Route("BuildingUnit/BuildingUnitUseTypes/Details")]
        ...
        [Route("BuildingUnit/BuildingUnitUseTypes/Create")]
        ...
        [HttpGet]
        [Route("BuildingUnit/BuildingUnitUseTypes/Edit")]
        ...
        [Route("BuildingUnit/BuildingUnitUseTypes/Delete")]
