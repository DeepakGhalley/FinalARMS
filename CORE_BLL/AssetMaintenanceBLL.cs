...
namespace CORE_BLL
{
    public class AssetMaintenanceBLL : IAssetMaintenance
    {
        ...
        public int SaveAssetMaintenance(AssetMaintenanceVM obj)
        {
            try
            {
                using TransactionScope s = new TransactionScope();
                int ipk;
                var entity = new TblAssetMaintenance
                {
                    AssetId = obj.AssetId,
                    MaintenanceTypeId = obj.MaintenanceTypeId,
                    MaintenanceDate = obj.MaintenanceDate,
                    MaintenanceCost = obj.MaintenanceCost,
                    Reason = obj.Reason,
                    DateofNextMaintenance = obj.DateofNextMaintenance,
                    SparePartUsed = obj.SparePartUsed,
                    ServiceOrderNo = obj.ServiceOrderNo,
                    ServiceOrderDate = obj.ServiceOrderDate,
                    Remarks = obj.Remarks,
                ...
                ctx.TblAssetMaintenance.Add(entity);
                ctx.SaveChanges();
                s.Complete();
                s.Dispose();
                ipk = entity.AssetMaintenanceId;
