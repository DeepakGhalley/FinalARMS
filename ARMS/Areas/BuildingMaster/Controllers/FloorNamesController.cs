...
namespace ARMS.Areas.BuildingMaster.Controllers
{
    ...
    public class FloorNamesController : Controller
    {
        ...
        [Route("BuildingMaster/FloorNames")]
        ...
        [Route("BuildingMaster/FloorNames/Details")]
        ...
        [Route("BuildingMaster/FloorNames/Create")]
        ...
        [HttpGet]
        [Route("BuildingMaster/FloorNames/Edit")]
        ...
        [Route("BuildingMaster/FloorNames/Delete")]
