...
GO
/*
The type for column standardCosumption in table [dbo].[trnWaterConnection] is currently  DECIMAL (10, 2) NOT NULL but is being changed to  INT NOT NULL. Data loss could occur and deployment may fail if the column contains data that is incompatible with type  INT NOT NULL.
*/
...
GO
ALTER TABLE [dbo].[trnWaterConnection] ALTER COLUMN [standardCosumption] INT NOT NULL;
