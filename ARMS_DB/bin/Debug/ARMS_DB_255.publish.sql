...
GO
PRINT N'Creating Foreign Key [dbo].[FK_tblLedger_ToTable_16]...';


GO
ALTER TABLE [dbo].[tblLedger] WITH NOCHECK
    ADD CONSTRAINT [FK_tblLedger_ToTable_16] FOREIGN KEY ([UnScheduledParkingRecordId]) REFERENCES [dbo].[tblUnScheduledParkingRecord] ([UnScheduledParkingRecordId]);
...
GO
ALTER TABLE [dbo].[tblLedger] WITH CHECK CHECK CONSTRAINT [FK_tblLedger_ToTable_16];
