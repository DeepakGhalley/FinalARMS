...
GO
/*
The column propertyTypeId on table [dbo].[mstLandDetail] must be changed from NULL to NOT NULL. If the table contains data, the ALTER script may not work. To avoid this issue, you must add values to this column for all rows or mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
PRINT N'Rename refactoring operation with key b1625349-f3aa-49dd-b9bf-e49dea4d7e9d is skipped, element [dbo].[enumPropertyType].[Id] (SqlSimpleColumn) will not be renamed to propertyTypeId';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'b1625349-f3aa-49dd-b9bf-e49dea4d7e9d')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('b1625349-f3aa-49dd-b9bf-e49dea4d7e9d')
