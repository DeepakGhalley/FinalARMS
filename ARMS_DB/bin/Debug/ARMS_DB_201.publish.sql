...
GO
/*
The column [dbo].[mstLandUseSubCategory].[taxTypeId] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[mstLandUseSubCategory])
...
GO
PRINT N'Altering Table [dbo].[mstLandUseSubCategory]...';


GO
ALTER TABLE [dbo].[mstLandUseSubCategory] DROP COLUMN [taxTypeId];
