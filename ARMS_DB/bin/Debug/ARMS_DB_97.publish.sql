...
GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__creat__509BDCCF]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__creat__509BDCCF];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__modif__51900108]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__modif__51900108];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__noOfU__48FABB07]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__noOfU__48FABB07];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__isMai__4EB3945D]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__isMai__4EB3945D];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__creat__4FA7B896]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__creat__4FA7B896];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__floor__49EEDF40]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__floor__49EEDF40];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__noOfr__4AE30379]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__noOfr__4AE30379];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__taxPa__4BD727B2]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__taxPa__4BD727B2];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__landD__4CCB4BEB]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__landD__4CCB4BEB];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__unitO__4DBF7024]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__unitO__4DBF7024];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__modif__52842541]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__modif__52842541];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__build__443605EA]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__build__443605EA];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__floor__452A2A23]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__floor__452A2A23];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__build__461E4E5C]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__build__461E4E5C];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__floor__47127295]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__floor__47127295];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__flatN__480696CE]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__flatN__480696CE];


GO
PRINT N'Dropping [dbo].[DF__tmp_ms_xx__trans__5378497A]...';


GO
ALTER TABLE [dbo].[mstBuildingUnitDetail] DROP CONSTRAINT [DF__tmp_ms_xx__trans__5378497A];
