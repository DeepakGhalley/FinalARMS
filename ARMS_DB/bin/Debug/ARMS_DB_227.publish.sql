...
CREATE TABLE [dbo].[tmp_ms_xx_trnSewerageConnection] (
    ...
    [plotNo]               NCHAR (10)      NULL,
    [thramNo]              NCHAR (10)      NULL,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_trnSewerageConnection] ([sewerageConnectionId], [transactionId], [amount], [g2cApplicationNo], [cid], [name], [mobileNo], [emailId], [contactAddress], [plotNo], [thramNo], [ownerName])
